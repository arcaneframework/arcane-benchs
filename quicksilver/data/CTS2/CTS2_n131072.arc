...
<case codename="Quicksilver" xml:lang="en" codeversion="1.0">
  ...
  <meshes>
    <mesh>
      <generator name="Cartesian3D" >
        ...
        <nb-part-x>64</nb-part-x>
        <nb-part-y>64</nb-part-y>
        <nb-part-z>32</nb-part-z>

        <origin>0.0 0.0 0.0</origin>

        <x>
          <length>2048.0</length>
          <n>2048</n>
        </x>
  ...
  <q-s>
    ...
    <eMin>1e-08</eMin>
    <nGroups>230</nGroups>
    <csvFile>./CTS2_n131072.csv</csvFile>
  </q-s>

  <sampling-m-c>
    <nParticles>5368709120</nParticles>
    <fMax>0.1</fMax>
